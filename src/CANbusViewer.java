 ...
 */
public class CANbusViewer extends javax.swing.JFrame implements CANMessageListener {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CANbusViewer.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                new CANbusViewer().setVisible(true);
            }
        });
    }
